...
print(f"There are {number_of_loans} available loans.")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
total_of_loans = sum(loan_costs)
print(f"The total value of all available loans is ${total_of_loans}.")
...
if present_value >= loan_price:
    print("Loan's a steal, bro. Get it.")
else:
    print("Ain't worth it. Hard pass.")
